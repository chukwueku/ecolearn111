...
var econometricsChapters_exports = {};
__export(econometricsChapters_exports, {
  ECONOMETRICS_CHAPTERS: () => ECONOMETRICS_CHAPTERS,
  ECONOMETRICS_PARTS: () => ECONOMETRICS_PARTS,
  getEconometricsExpansion: () => getEconometricsExpansion
});
module.exports = __toCommonJS(econometricsChapters_exports);
const ECONOMETRICS_PARTS = [
...
const getEconometricsExpansion = (id) => {
  const expansions = {
    1: {
