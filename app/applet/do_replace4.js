...
let content = fs.readFileSync(path.join(__dirname, 'src/lib/advancedStudyData.ts'), 'utf8');
...
fs.writeFileSync(path.join(__dirname, 'src/lib/advancedStudyData.ts'), content, 'utf8');
